...
public class ByteStream {
    ...
    private static void toFile(InputStream ins, FileOutputStream fos, int len, int buf_size,File file) throws
            java.io.IOException {
        ...
        String str = convertInputStreamToString(ins);
